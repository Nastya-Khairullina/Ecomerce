      ...
      if (state is HomeLoadedState) {
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            if (state.loadedHomestore[index].isBestSeller == true) {
              GridWidget{
                pictureUrl:state.loadedHomestore[index].picture;
                titleItems: state.loadedHomestore[index].title;
                priceWithoutDiscount:state.loadedHomestore[index].priceWithoutDiscount;
            discountPrice: state.loadedHomestore[index].discountPrice;
            isFavorites: state.loadedHomestore[index].isFavorites;
            isBestSeller: state.loadedHomestore[index].isBestSeller ?? false;
            id: state.loadedHomestore[index].id;}}},
